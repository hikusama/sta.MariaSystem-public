...
function db_connect()
{
    ...
    try {
        ...
        $tableQueries = [
            ...
            "CREATE TABLE IF NOT EXISTS sf10_remedial_class (
                sf10_rem_id INT AUTO_INCREMENT PRIMARY KEY,
                school_year VARCHAR(255) DEFAULT NULL,
                sf10_data_id INT NOT NULL,
                created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                FOREIGN KEY(sf10_data_id) REFERENCES sf10_data(id) ON DELETE CASCADE
            )",
            "CREATE TABLE IF NOT EXISTS remedial_class (
                remedial_id INT AUTO_INCREMENT PRIMARY KEY,
                sf10_rem_id INT NOT NULL,
                ...
                FOREIGN KEY (sf10_rem_id) REFERENCES sf10_remedial_class(sf10_rem_id) ON DELETE CASCADE
            )",
